...
class domestic: public customer{
    ...
    void getd(){
        int flch;
        ifstream i;
        cout<<"Enter which flight you wanna chose: ";
        cin>>flch;
...
void showflights(char ch){
    ...
    flights fl;
    cout<<"Inital | Final | Price | Date of flight\n";
    cout<<"---------------------------------------\n";
    while(getline(i,check)){
        cout<<check<<endl;
    }
